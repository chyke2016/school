define(function (require) {
    ...
    var Base_Page_View = require('base/js/Base_Page_View'),
        template = require('text!html/Forgot_Pwd/Forgot_Pwd_Success_View.html'),

        AppData = require('js/appData');

    var Forgot_Pwd_Success_View = Base_Page_View.extend({

        id: "Forgot_Pwd_Success",
        ...
        initialize: function (config) {
            Forgot_Pwd_Success_View.__super__.initialize.apply(this, [config]);
        },

        _render: function () {
            Forgot_Pwd_Success_View.__super__._render.apply(this);
    ...
    return Forgot_Pwd_Success_View;
