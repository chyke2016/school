define(function (require) {
    ...
    var Base_Page_View = require('base/js/Base_Page_View'),
        template = require('text!html/Branches/Branches_View.html'),
    ...
    var Branches_View = Base_Page_View.extend({
        ...
        initialize: function (config) {
            Branches_View.__super__.initialize.apply(this, [config]);
        },

        _render: function () {
            Branches_View.__super__._render.apply(this);
