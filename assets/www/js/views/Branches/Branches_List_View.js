define(function (require) {
    ...
    var Base_Page_View = require('base/js/Base_Page_View'),
        template = require('text!html/Branches/Branches_List_View.html'),
    ...
    var Branches_List_View = Base_Page_View.extend({
        ...
        initialize: function (config) {
            Branches_List_View.__super__.initialize.apply(this, [config]);
        },

        _render: function () {
            Branches_List_View.__super__._render.apply(this);
        },
                ...
                $.ajax({
                    ...
                    success: function (data, status, xhr) {
                        ...
                        if (data.total_rows && data.total_rows > 0) {
                            ...
                            $('.Branches_List_Data').html(domStr);
                        } else {
                            document.dispatchEvent(new CustomEvent('alert', {
                                'detail': 'Not able to fetch branch list.'
                            }));

                        }
                    },
                    error: function (err) {
                        $('.Branches_List_Loader').fadeOut();
                        document.dispatchEvent(new CustomEvent('alert', {
                            'detail': err.message
                        }));
