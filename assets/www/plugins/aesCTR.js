define(function (require) {
    ...
    Aes.cipher = function (input, w) {
        ...
        var state = [
            ...
            [],
            []
        ]; // initialise 4xNb byte-array 'state' with
        // input [�3.4]
...
// keyExpansion [�5.1.1]
    Aes.sBox = [  ];
...
// GF(2^8)] [�5.2]
    ...
    Aes.Ctr.encrypt = function (plaintext, password, nBits) {
        ...
        // expansion) - gives us well encrypted key (though hashed key might be
        // preferred for prod'n use)
        var nBytes = nBits / 8; // no bytes in key (16/24/32)
        var pwBytes = new Array(nBytes);
        for (var i = 0; i < nBytes; i++) { // use 1st 16/24/32 chars of password
            // for key
